...
from .views.rest_api import ProfileAPIView, UserInfoAPIView, PublicQSOSearchAPIView, public_qso_search_html
...
urlpatterns = [
    ...
    path('profile/verify-lotw/', verify_lotw_credentials, name='verify_lotw_credentials'),
    path('dashboard/profile/verify-lotw/', verify_lotw_credentials, name='verify_lotw_credentials_legacy'),
    path('profile/delete-lotw/', delete_lotw_credentials, name='delete_lotw_credentials'),
    path('dashboard/profile/delete-lotw/', delete_lotw_credentials, name='delete_lotw_credentials_legacy'),
    ...
    # Публичный HTML поиск (без JavaScript) для QRZ.com
    path('public/qso-search/', public_qso_search_html, name='public_qso_search_html'),
