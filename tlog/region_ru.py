...
class RussianRegionFinder:
    ...
    def _load_region_data(self):
        ...
        return {
            ...
            'KO': 'Республика Коми',
            'KP': 'Коми-Пермяцкий атономный округ (deleted)',
            ...
            'AL': 'Алтайский край',
            'GA': 'Республика Алтай',
            'TM': 'Таймырский атоновмный округ (deleted)'
        }
    ...
    def _get_region_code(self, zone, letter):
        ...
        mapping = {
            '0': {'A':'KK','B':'KK','H':'KK','C':'HK','D':'EA','E':'SL','F':'SL',
                  ...
                  'Q':'YA','S':'IR','T':'IR','U':'CT','V':'CT','W':'HA','X':'KT',
                  'Z':'KT','Y':'TU'},
            ...
            '2': {'A':'MA','B':'MA','C':'MA','D':'MO','H':'MO','E':'OR','F':'KA',
                  'K':'KA','G':'LP','I':'TV','L':'SM','M':'JR','N':'KS','O':'VR',
                  'Q':'VR','P':'TL','R':'TB','S':'RA','T':'NN','U':'IV','V':'VL',
                  'W':'KU','X':'KG','Y':'BR','Z':'BO'},
            '3': {'A':'MA','D':'MO','O':'VR','W':'KU','B':'MO','C':'MO','F':'MO',
                  'H':'MO','J':'SM','M':'JR','E':'OR','G':'LP','I':'TV','K':'VR',
            ...
            '5': {'A':'MA','D':'MO','O':'VR','W':'KU','B':'MO','C':'MO','F':'MO',
                  'H':'MO','J':'SM','M':'JR','E':'OR','G':'LP','I':'TV','K':'VR',
                  'Q':'VR','L':'SM','N':'KS','P':'TL','R':'TB','S':'RA','T':'NN',
                  'U':'IV','V':'VL','X':'KG','Y':'BR','Z':'BO'},
            '6': {'A':'KR','B':'KR','C':'KR','D':'KR','E':'KC','F':'ST','G':'ST',
                  'H':'ST','T':'ST','I':'KM','J':'SO','K':'RK','L':'RO','M':'RO',
                  'N':'RO','O':'DO','P':'CC','Q':'IN','R':'SE','S':'ZP','U':'AO',
                  'V':'AO','W':'DA','X':'KB','Y':'AD','Z':'LU'},
            '7': {'A':'KR','B':'KR','C':'KR','D':'KR','E':'KC','F':'ST','G':'ST',
                  'H':'ST','T':'ST','I':'KM','J':'SO','K':'RK','L':'RO','M':'RO',
                  'N':'RO','O':'DO','P':'CC','Q':'IN','R':'SE','S':'ZP','U':'AO',
                  'V':'AO','W':'DA','X':'KB','Y':'AD','Z':'LU'},
