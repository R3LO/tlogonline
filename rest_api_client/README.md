...
- **Дата** — дата и время QSO (формат ДД.ММ.ГГГГ ЧЧ:ММ)
...
- **Поиск и QSO**: дата и время отображаются в формате `ДД.ММ.ГГГГ ЧЧ:ММ`
- **LoTW**: дата QSO и дата подтверждения отображаются в формате `ДД.ММ.ГГГГ ЧЧ:ММ`
